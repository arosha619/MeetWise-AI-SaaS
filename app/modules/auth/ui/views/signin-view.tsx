        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              ...
              >
                <path
                  d="M44.5 20H24v8.5h11.9C34.3 33 30 36 24 36c-7.7 0-14-6.3-14-14s6.3-14 14-14c3.8 0 7.2 1.5 9.6 4l6.8-6.8C35.7 2.6 30.1 0 24 0 10.7 0 0 10.7 0 24s10.7 24 24 24c12.3 0 22.4-9.8 23.9-22.2.1-.8.1-1.6.1-1.8 0-.6-.1-1.2-.5-1.8z"
                  fill="#4285F4"
                />
              </svg>
              Google
            ...
            >
              ...
              >
                <path
                  d="M22 12c0-5.5-4.5-10-10-10S2 6.5 2 12c0 4.9 3.5 8.9 8 9.8v-6.9H7.8V12H10V9.6c0-2.2 1.3-3.4 3.2-3.4.9 0 1.8.1 1.8.1v2h-1c-1 0-1.3.6-1.3 1.3V12h2.2l-.4 2.9H13.7v6.9c4.5-.9 8-4.9 8-9.8z"
                  fill="#1877F2"
                />
              </svg>
              Facebook
